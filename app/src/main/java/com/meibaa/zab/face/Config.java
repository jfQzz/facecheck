...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "gcVmIL2ROz2HF6Vn9GNfhwzV";
    public static String secretKey = "bWXhnCG0XpeyBGPBS9ZBdBYV34CcAblx";
    public static String licenseID = "ZAB1314520-face-android";
     ...
     */
    public static String groupID = "14243253";
